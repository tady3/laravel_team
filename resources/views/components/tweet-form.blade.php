...
<div class="mb-2">
    <p class="mb-1 text-gray-400 font-weight-bold" style="font-size: 1.2rem;">スキな「コトバ」と「キブン」を持ち運ぼう</p>
...
<!-- 多田追記 -->
    <select id="" name="when" class="">
        <option disabled selected style="display:none;">心に刺さった時期</option>>
    ...
    <select id="" name="rate" class="">
        <option disabled selected style="display:none;">推し度★: 1〜5</option>>
