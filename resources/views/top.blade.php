                    ...
                    @if (Route::has('login'))
                        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                            ...
                            <div>
                                ...
                                <div class="mb-2">
                                    <a href="https://factly.sakura.ne.jp/laravel_team/redirect-to-google" class="btn btn-primary btn-rounded font-weight-bold btn-lg shadow-1" style="width: 200px;" role="button">
                                        Google ログイン
                                    </a>
                                </div>
                            </div>
