<x-app-layout>
    ...
    <form method="GET" action="/search">   
        ...
        <div class="relative">
            ...
            <input type="search" id="default-search" class="block p-4 pl-10 w-full text-sm bg-blue-100 text-blue-800 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  placeholder="  投稿を検索" name="keyword" value="@if (isset($search)) {{ $search }} @endif">
